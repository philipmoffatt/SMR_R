...
print "Weather file directory is: /$home_dir_name/$user/Dropbox/SMR_R/raw_data/weather\n";
...
print `r.mapcalc 'input_daily_balance = 0.0' --o`;
	...
	print `r.mapcalc 'storage_amt = if(strms_30m > 0,sat_amt,storage_amt + input)' --o`;
