...
params:
  ...
  mapset: "duncanjurayj"
  run_start: "1965-10-01"
  run_end: "1970-10-01"
  simulation_note: 'testing R markdown workflow and directory system'
---
...
## Run Identification:
      ...
      Modeled Period: `r params$run_start to params$run_end`

```{r version_track, echo=FALSE, include=FALSE}
version_tracked_outpath <- version_tracker(modeled_data_path, simulation_note = params$simulation_note)
```
