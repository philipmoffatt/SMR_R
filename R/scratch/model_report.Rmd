...
```{r, Q comparison call, warning=FALSE, include=FALSE, echo=FALSE}
...
#annual_mass_balance(VaM_data, log_transform = F)
# causing error right now but mass balance is: precip + snow melt - percolation
...
```{r, annual fluxes,echo = FALSE, include = FALSE, eval = TRUE}
...
```{r, getting map outputs, echo = TRUE}
