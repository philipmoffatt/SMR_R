...
#   this method should allow multiple users on different 
...
print "Weather file directory is: /$home_dir_name/$user/Dropbox/SMR_R/raw_data/weather/noaa_pullman_mini.csv\n";
...
open ($WEATHER, '<', "/Users/philipmoffatt/Dropbox/SMR_R/raw_data/weather/noaa_pullman_mini.csv") || die "Can't open weather file\n"; 
#print "\n|----- line 280 -----|\n";
...
#____________________________________________________________________________________
  ...
  print "\n|---------- nasty map loop ----------|\n";
    print `r.out.gdal input=precip_$year output=C:/$home_dir_name/$user/Dropbox/SMR_R/raw_data/smr_output/maps_$user/precip_$year.tif --o`;
    print `r.out.gdal input=pet_$year output=C:/$home_dir_name/$user/Dropbox/SMR_R/raw_data/smr_output/maps_$user/pet_$year.tif --o`; 
  }
  ...
  if ($doy == 365) { # need to make 365 eventually once markdown is set up
    ...
    open(OUT, ">>", "/Users/philipmoffatt/Dropbox/SMR_R/raw_data/smr_output/MFC_mass_balance_philipmoffatt.csv") || die "Can't open output file\n";
