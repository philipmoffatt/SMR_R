...
print "Weather file directory is: /$home_dir_name/$user/Dropbox/SMR_R/raw_data/weather/noaa_pullman.csv\n";
...
print `r.mapcalc 'snowmelt = if(water_input>0.0,snowmelt*(water_input)/water_input,snowmelt)' --o`;
print `r.mapcalc 'throughfall = if(water_input>0.0,throughfall*(water_input)/water_input,throughfall)' --o`;
  ...
  if ($doy == 365) { # need to make 365 eventually once markdown is set up
	...
	while (<$WATERSHED>) {
      ...
      print "\n|-----The runoff_daily_flow is $temp1 -----|\n";			
		...
		# **********************************  27  ***************************************
		print "\n|----- annual average long wave radiation -----|\n";
		# q.lw output
		...
		# **********************************  30 ***************************************
		print "\n|----- annual average ice content of snowpack -----|\n";
		# ice.content
		...
		# ********************************** 31  ***************************************
		print "\n|----- annual average liquid water content of swe -----|\n";
		# liquid.water
		...
		# **********************************  32 ***************************************
		print "\n|----- annual average water that froze to return snowpack temp to 0 -----|\n";
		# refreeze
		...
		# **********************************  33 ***************************************
		print "\n|----- annual average vapor pressure of the air -----|\n";
		# vap.d.air
		...
		# **********************************  34 ***************************************
		print "\n|----- annual average vapor pressure of the snow -----|\n";
		# vap.d.snow
		...
		# **********************************  35 ***************************************
		print "\n|----- annual average energy content of the snowsurface -----|\n";
		# u.surface
