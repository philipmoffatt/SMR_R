...
pet_lapse <- gridMET_difference_lapse(met_pullman, met_moscow, variable_name = "pet_grass", 784, 1433)
...
temp_lapse_model <- gridMET_model_lapse(met_pullman, met_moscow, variable_name = "tavg", 784, 1433)
